...
bool requestGfciStatus(){
  return digitalRead(GFCI_MASTER);
}
...
void Master_setup() {
 ...
 // Serial.begin(115200);
  masterSerial.begin(9600,SWSERIAL_8N1, 25,33, false,256); // upating the sw serial
  Serial.println("Master is all set to Rock");
  pinMode(GFCI_MASTER,INPUT);
